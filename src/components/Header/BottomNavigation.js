...
const BottomNavigation = () => {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-lavender-900 shadow-lg">
      <div className="grid grid-cols-5 h-16">
        <Link
          to="/"
          className={`flex flex-col items-center justify-center ${
            isActive('/') ? 'text-white bg-lavender-700' : 'text-lavender-200 hover:text-white'
          }`}
        >
          <HomeIcon />
        ...
        <Link
          to="/dog-resources"
          className={`flex flex-col items-center justify-center ${
            isActive('/dog-resources') ? 'text-white bg-lavender-700' : 'text-lavender-200 hover:text-white'
          }`}
        >
          <DogIcon />
        ...
        <Link
          to="/cat-resources"
          className={`flex flex-col items-center justify-center ${
            isActive('/cat-resources') ? 'text-white bg-lavender-700' : 'text-lavender-200 hover:text-white'
          }`}
        >
          <CatIcon />
        ...
        <Link
          to="/profile"
          className={`flex flex-col items-center justify-center ${
            isActive('/profile') ? 'text-white bg-lavender-700' : 'text-lavender-200 hover:text-white'
          }`}
        >
          <ProfileIcon />
