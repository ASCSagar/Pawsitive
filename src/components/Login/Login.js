...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-lavender-100 to-lavender-300 flex items-center justify-center p-4 md:p-12 relative overflow-hidden">
      ...
      {/* Main login card */}
      <div className={`max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden transform transition-all duration-500 ${showContent ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} relative z-10`}>
        <div className="p-8">
          ...
          <h2 className="text-3xl font-bold text-center text-lavender-900 mb-2">Welcome to Pawsitive</h2>
          <p className="text-center text-lavender-600 mb-6">Your ultimate pet resource finder</p>
          
          <div className="bg-lavender-50 rounded-lg p-4 mb-6 border-l-4 border-lavender-500 relative overflow-hidden">
            {/* Animated paw icon that moves across the info box */}
            <div className="absolute -right-4 top-1/2 transform -translate-y-1/2 opacity-10 text-4xl animate-move-horizontal">
              🐾
            </div>
            
            <h3 className="font-semibold text-lavender-800 mb-2">Find everything your pet needs:</h3>
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className="flex items-center transform transition-transform duration-300 hover:scale-105">
                <span className="mr-2 animate-pulse" style={{ animationDelay: '0.5s' }}>🍖</span>
                <span className="text-sm">Nutrition</span>
              </div>
              <div className="flex items-center transform transition-transform duration-300 hover:scale-105">
                <span className="mr-2 animate-pulse" style={{ animationDelay: '1s' }}>🧶</span>
                <span className="text-sm">Supplies</span>
              </div>
              <div className="flex items-center transform transition-transform duration-300 hover:scale-105">
                <span className="mr-2 animate-pulse" style={{ animationDelay: '1.5s' }}>🦮</span>
          ...
          >
            ...
            <span className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-20 transition-opacity">
              <span className="text-3xl filter blur-sm animate-spin-slow">🐾</span>
            </span>
            
            <svg className="w-6 h-6 mr-2 relative z-10" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {showInstallButton && (
            <div className="mt-4">
              ...
              >
                {/* Animated download effect on hover */}
                <span className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-20 transition-opacity">
        ...
        <div className="bg-lavender-50 p-6 border-t border-lavender-200 relative overflow-hidden">
          ...
          <div className="absolute -left-10 -bottom-5 text-6xl opacity-5 animate-pulse-slow" style={{ animationDelay: '1.5s' }}>
            🐈
          </div>
          ...
          <div className="flex items-start space-x-4 relative z-10">
            ...
            <div>
              <p className="text-sm text-lavender-800 italic">
                "Find veterinarians, pet stores, groomers, and more with just a few taps. The perfect app for pet parents!"
              </p>
      ...
      <div className="absolute top-10 right-10 text-6xl text-white opacity-20 transform -rotate-12 animate-pulse-slow" style={{ animationDelay: '2s' }}>
        🐈
      </div>
    </div>
  );
