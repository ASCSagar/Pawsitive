...
const catResourceCategories = [
  {
    ...
    icon: "🏥",
    description: "Veterinarians, emergency care, grooming, dental care, and preventative treatments.",
    examples: [
  ...
  },
  {
    ...
    name: "Nutrition",
    icon: "🍖",
    description: "Pet food stores, specialty foods, treats, and water supplies for your cat.",
    examples: [
      "Cat food stores",
      "Online retailers",
      "Treat suppliers",
  ...
  },
  {
    ...
    icon: "🧶",
    description: "Collars, harnesses, carriers, beds, bowls, toys, and scratching posts.",
    examples: [
      "Collars & harnesses",
      "Carriers",
      "Beds & bowls",
  ...
  },
  {
    ...
    name: "Services",
    icon: "🐾",
    description: "Cat sitters, groomers, behaviorists, boarding facilities, and catteries.",
    examples: [
      "Cat sitting",
      "Grooming",
      "Behavior training",
  ...
  },
  {
    ...
    icon: "📚",
    description: "Online resources, breed info, animal shelters, pet communities, and helplines.",
    examples: [
      "Online resources",
      "Breed guides",
      "Shelters & rescues",
  ...
  },
  {
    ...
    icon: "🏷️",
    description: "Microchipping, ID tags, licensing, and local animal regulations.",
    examples: [
      "Microchipping",
      "ID tags",
      "Licensing",
  ...
  return (
    ...
    >
      <div className="flex items-center p-4 border-b border-lavender-100">
        ...
        <h3 className="text-lg font-semibold text-lavender-900">{category.name}</h3>
      </div>
      <div className="p-4">
        <p className="text-sm text-gray-600 mb-3">{category.description}</p>
        
        <div className="mb-4">
          <h4 className="text-xs font-medium text-lavender-800 mb-2">Common services:</h4>
        ...
        <button 
          className="w-full bg-lavender-600 text-white py-2 rounded-md text-sm font-medium hover:bg-lavender-700 transition-colors duration-300 mt-2"
        >
          View Resources
        </button>
      </div>
...
const CatResources = () => {
  ...
  const filteredCategories = searchTerm 
    ? catResourceCategories.filter(category =>
    ...
    : activeMobileCategory && isMobile
      ? catResourceCategories.filter(category => category.id === activeMobileCategory)
    ...
    <div className="min-h-screen bg-lavender-50">
      ...
      <div className="bg-lavender-700 text-white py-8">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-lg text-lavender-100">Find everything your feline friend needs</p>
        </div>
      </div>
      ...
      {isMobile && !searchTerm && (
        <div className="sticky top-14 z-10 bg-lavender-50 pt-4 pb-2 px-6 -mx-6">
          <MobileCategorySelector 
            ...
            onSelect={(id) => setActiveMobileCategory(id === activeMobileCategory ? null : id)}
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        {!isMobile && <h2 className="text-xl font-bold text-lavender-900 mb-6">Resource Categories</h2>}
        ...
        {filteredCategories.length > 0 ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow-sm">
            ...
            <h3 className="text-xl font-semibold text-lavender-900 mb-2">No categories found</h3>
      ...
      <div className="bg-lavender-100/50 py-8">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-xl font-bold text-lavender-900 mb-6">Featured Resources</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-4 border-l-3 border-lavender-500">
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-lavender-900">Feline Health Center</h3>
                </div>
                <p className="text-gray-600 text-sm mb-2">Specialized veterinary care for cats of all breeds and ages.</p>
                <p className="text-xs text-gray-500">Near City Park, Vadodara</p>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-4 border-l-3 border-lavender-500">
                <div className="flex items-center mb-3">
                  <span className="text-2xl mr-3">🧶</span>
                  <h3 className="text-lg font-semibold text-lavender-900">Cat Supplies Boutique</h3>
                </div>
                <p className="text-gray-600 text-sm mb-2">Premium cat supplies, toys, and specialty products.</p>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-4 border-l-3 border-lavender-500">
                <div className="flex items-center mb-3">
                  <span className="text-2xl mr-3">🐾</span>
                  <h3 className="text-lg font-semibold text-lavender-900">Whiskers Grooming Salon</h3>
                </div>
                <p className="text-gray-600 text-sm mb-2">Professional cat grooming services and spa treatments.</p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="bg-white rounded-lg shadow-sm p-6 flex flex-col md:flex-row items-center border border-lavender-200">
          <div className="md:w-2/3 mb-6 md:mb-0 md:pr-8">
            <h2 className="text-xl font-semibold text-lavender-900 mb-3">Find Cat Resources Near You</h2>
            <p className="text-gray-600 text-sm mb-4">
              Use our location-based search to discover cat-friendly services, stores, and facilities in your neighborhood.
            </p>
            <button 
