...
const featuredResources = [
  {
    title: "Feline Health Center",
    description: "Specialized veterinary care for cats of all breeds and ages.",
    address: "Near City Park, Vadodara",
    buttonTitle: "Find Cat Clinics",
    icon: <Hospital size={16} className="ml-1" />,
  },
  {
    title: " Cat Supplies Boutique",
    description: "Premium cat supplies, toys, and specialty products.",
    address: "Alkapuri, Vadodara",
    buttonTitle: "Find Cat Supplies",
    icon: <Store size={16} className="ml-1" />,
  },
  {
    title: "Whiskers Grooming Salon",
    description: "Professional cat grooming services and spa treatments.",
    address: "Sayajigunj, Vadodara",
    buttonTitle: "Find Grooming Services",
