...
const dogResourceCategories = [
  ...
  },
  {
    ...
    name: "Nutrition",
    icon: "🍖",
    description: "Pet food stores, specialty foods, treats, and water supplies for your dog.",
    examples: [
      "Pet food stores",
      "Online retailers",
      "Treat suppliers",
  ...
  },
  {
    ...
    icon: "🧶",
    description: "Collars, leashes, carriers, beds, bowls, toys, and grooming supplies.",
    examples: [
      "Collars & leashes",
      "Carriers & crates",
      "Beds & bowls",
  ...
  },
  {
    ...
    name: "Services",
    icon: "🦮",
    description: "Dog walkers, pet sitters, trainers, boarding facilities, and daycares.",
    examples: [
      "Dog walking",
      "Pet sitting",
      "Training",
...
const DogResources = () => {
  ...
  const filteredCategories = searchTerm 
    ...
    : activeMobileCategory && isMobile
      ? dogResourceCategories.filter(category => category.id === activeMobileCategory)
    ...
    <div className="min-h-screen bg-lavender-50">
      ...
      <div className="bg-lavender-700 text-white py-8">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-lg text-lavender-100">Find everything your canine companion needs</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-4 border-l-3 border-lavender-500">
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-lavender-900">City Pet Hospital</h3>
                </div>
                <p className="text-gray-600 text-sm mb-2">Comprehensive veterinary care for dogs of all breeds and ages.</p>
                <p className="text-xs text-gray-500">Near Police Parade Ground, Vadodara</p>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-4 border-l-3 border-lavender-500">
                <div className="flex items-center mb-3">
                  <span className="text-2xl mr-3">🍖</span>
                  <h3 className="text-lg font-semibold text-lavender-900">Pet Food Emporium</h3>
                </div>
                <p className="text-gray-600 text-sm mb-2">Premium dog foods, treats, and specialty nutrition products.</p>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-4 border-l-3 border-lavender-500">
                <div className="flex items-center mb-3">
                  <span className="text-2xl mr-3">🦮</span>
                  <h3 className="text-lg font-semibold text-lavender-900">Paws & Learn Training</h3>
                </div>
                <p className="text-gray-600 text-sm mb-2">Professional dog training and behavioral solutions.</p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="bg-white rounded-lg shadow-sm p-6 flex flex-col md:flex-row items-center border border-lavender-200">
          <div className="md:w-2/3 mb-6 md:mb-0 md:pr-8">
            <h2 className="text-xl font-semibold text-lavender-900 mb-3">Find Dog Resources Near You</h2>
            <p className="text-gray-600 text-sm mb-4">
              Use our location-based search to discover dog-friendly services, stores, and facilities in your neighborhood.
            </p>
            <button 
